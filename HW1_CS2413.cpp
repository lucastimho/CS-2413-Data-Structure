...
float University::GPA_Mean() // Prints the mean GPA of of the five students held by Sooner[5]
{
	float sum = 0.0;
	float mean;
	for (int i = 0; i < 5; i++)
...
float University::GPA_Max() // Prints the max GPA of the five students
{
...
float University::GPA_Min() // Prints the minimum GPA of the five students
{
